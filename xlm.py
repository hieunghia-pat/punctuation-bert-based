...
from transformers import (XLMForTokenClassification, XLMTokenizer, XLMConfig,
                          AdamW, get_linear_schedule_with_warmup, XLMModel)
...
class PunctuationPredictionModel(XLMForTokenClassification):

    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,valid_ids=None,attention_mask_label=None):
        sequence_output = self.transformer(input_ids, token_type_ids=token_type_ids, attention_mask=attention_mask, head_mask=None)[0]
...
def main():
    ...
    # Prepare model
    config = XLMConfig.from_pretrained(args.bert_model, num_labels=num_labels, finetuning_task=args.task_name)
    ...
    if args.do_train:
        ...
        tokenizer = XLMTokenizer.from_pretrained(args.output_dir)
